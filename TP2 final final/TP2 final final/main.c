...
int altaEmpleado(int idA, char nameAux, char lastNameAux, int salaryAux, char sectorAux,Employee vec[], int tam)
{
    ...
    else
    {
        ...
        nuevoEmpleado.id = idA;
        //strcpy(nuevoEmpledo[indice].id,idA);
        strcpy(nuevoEmpleado.name,nameAux);
        strcpy(nuevoEmpleado.lastName,lastNameAux);
        // salaryAux = atof(salaryAux);
        //nuevoEmpledo.salary = salaryAux;

        nuevoEmpleado.salary = atof(salaryAux);
        // sectorAux = atof(sectorAux);
        // nuevoEmpledo.sector = sectorAux;
        nuevoEmpleado.sector = atof(sectorAux);
...
void bajaEmpleado(Employee vec[],int tam)
{
    ...
    if(!getStringNumeros("ingrese id a borrar",idBorrar))
    {
        printf("Error.Ingrese solo numeros");
    }
